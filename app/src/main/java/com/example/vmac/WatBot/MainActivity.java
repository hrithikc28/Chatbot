...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        ...
        service.setUsernameAndPassword("def410b4-44d4-4532-aba3-7fd5c3a151aa", "AdRfHSXm5cOS");

        InputData input = new InputData.Builder(inputmessage).build();
        MessageOptions options = new MessageOptions.Builder("97a39385-b270-49ea-b308-30c12f71a25c").input(input).context(context).build();
